...
curl -L -o vmlinuz "https://github.com/netbootxyz${yamlendpoints_ubuntu_23_10_KDE_squash_path}vmlinuz"
...
if isKernelNewerThanOnBlobStorage "$kernelVersion"; then
    ...
    # Download initrd
    curl -L -o initrd "https://github.com/netbootxyz${yamlendpoints_ubuntu_23_10_KDE_squash_path}initrd"
